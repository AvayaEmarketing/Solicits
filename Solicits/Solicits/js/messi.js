...
function Messi(data, options) {
  ...
  if(_this.options.buttons.length > 0) {
    ...
    for (var i = 0; i < _this.options.buttons.length; i++) {
      ...
      var btn = jQuery('<span class="btnbox"><button data-value="' + _this.options.buttons[i].val + '" class="btn ' + cls + '" href="#">' + _this.options.buttons[i].label + '</button></span>').data('value', _this.options.buttons[i].val);
