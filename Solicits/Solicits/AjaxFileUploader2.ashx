<%@ WebHandler Language="C#" Class="AjaxFileUploader2" %>
...
using System.Configuration;
    ...
    /// </summary>
    public class AjaxFileUploader2 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
		{
			if (context.Request.Files.Count > 0)
			{
				...
				path = context.Server.MapPath("~") + "\\Translations";
				...
				string fullPath = HttpContext.Current.Server.MapPath("~") + "\\Translations\\" + hora + "-" + fileName;
		...
		public static string actualizar(int id, string nombre)
		{
			...
			string strSQL = "update Translate_Solicits set T_document_translate = @nombre where solicit_id = @id";
