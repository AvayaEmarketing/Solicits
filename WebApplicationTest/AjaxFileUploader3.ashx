<%@ WebHandler Language="C#" Class="AjaxFileUploader3" %>
...
using System.Configuration;
    ...
    /// </summary>
    public class AjaxFileUploader3 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
		{
			if (context.Request.Files.Count > 0)
			{
				...
				path = context.Server.MapPath("~") + "\\Corrections";
				...
				string fullPath = HttpContext.Current.Server.MapPath("~") + "\\Corrections\\" + hora + "-" + fileName;
		...
		public static string actualizar(int id, string nombre)
		{
			...
			string strSQL = "update Translate_Solicits set ST_correction = @nombre where solicit_id = @id";
